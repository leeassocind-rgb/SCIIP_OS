...
var SCIIP_APPLICATION = (function () {
  ...
  var WORKSPACES = [
    ...
    {id:'digital-twin',label:'Digital Twin',description:'Operational property model, history, relationships, and competitive context.',capability:'digital-twin'},
    {id:'spatial-intelligence',label:'Spatial Intelligence',description:'Radius analysis, competitive influence, GIS layers, and suitability ranking.',capability:'spatial'},
  ...
  function bootstrap(e){var p=e&&e.parameter||{},view=String(p.view||'dashboard');if(!WORKSPACES.some(function(w){return w.id===view;}))view='dashboard';return {
    ...
    digitalTwin:typeof SCIIP_INDUSTRIAL_DIGITAL_TWIN!=='undefined'?SCIIP_INDUSTRIAL_DIGITAL_TWIN.sample():null,
    spatialIntelligence:typeof SCIIP_SPATIAL_INTELLIGENCE!=='undefined'?SCIIP_SPATIAL_INTELLIGENCE.workspace():null,
