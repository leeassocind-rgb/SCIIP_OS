...
function sciipGetOrCreateSheet(
  sheetName
) {
...
function sciipAppendRow(
  sheetName,
  row
) {

  const sheet =
    sciipGetOrCreateSheet(
      sheetName
    );
