...
const file=path.join(root,"src/applications/enterprise-data-governance/SCIIP_V8_Enterprise_Data_Governance_Master_Data_Quality_Lineage_Stewardship.gs");
...
if(!result||result.status!=="PASSED"||result.testsRun!==40){console.error(JSON.stringify(result,null,2));process.exit(1);}
