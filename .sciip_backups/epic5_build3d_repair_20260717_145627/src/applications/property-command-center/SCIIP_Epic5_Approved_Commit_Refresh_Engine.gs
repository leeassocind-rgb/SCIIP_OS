...
var SCIIP_EPIC5_APPROVED_COMMIT_REFRESH = (function () {
  'use strict';
  var VERSION = 'v7.0-epic5-build3d.0';
  ...
  function rollback(commitId, reason, token) {
    ...
    if (typeof SpreadsheetApp !== 'undefined') appendRows_('INGESTION_ROLLBACK_LEDGER', ['Commit_ID','Business_Key','Reason','Rolled_Back_By','Rolled_Back_At'], [[found.commitId,key,found.rollback.reason,found.rollback.rolledBackBy,found.rollback.rolledBackAt]]);
